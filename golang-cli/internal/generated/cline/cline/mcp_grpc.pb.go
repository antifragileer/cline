...
const (
	...
	McpService_AuthenticateMcpServer_FullMethodName            = "/cline.McpService/authenticateMcpServer"
...
type McpServiceClient interface {
	...
	AuthenticateMcpServer(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *mcpServiceClient) AuthenticateMcpServer(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, McpService_AuthenticateMcpServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type McpServiceServer interface {
	...
	AuthenticateMcpServer(context.Context, *StringRequest) (*Empty, error)
	// Subscribe to MCP marketplace catalog updates
...
func (UnimplementedMcpServiceServer) ToggleMcpServer(context.Context, *ToggleMcpServerRequest) (*McpServers, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleMcpServer not implemented")
}
func (UnimplementedMcpServiceServer) UpdateMcpTimeout(context.Context, *UpdateMcpTimeoutRequest) (*McpServers, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMcpTimeout not implemented")
}
func (UnimplementedMcpServiceServer) AddRemoteMcpServer(context.Context, *AddRemoteMcpServerRequest) (*McpServers, error) {
	return nil, status.Error(codes.Unimplemented, "method AddRemoteMcpServer not implemented")
}
func (UnimplementedMcpServiceServer) DownloadMcp(context.Context, *StringRequest) (*McpDownloadResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DownloadMcp not implemented")
}
...
func (UnimplementedMcpServiceServer) ToggleToolAutoApprove(context.Context, *ToggleToolAutoApproveRequest) (*McpServers, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleToolAutoApprove not implemented")
}
func (UnimplementedMcpServiceServer) RefreshMcpMarketplace(context.Context, *EmptyRequest) (*McpMarketplaceCatalog, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshMcpMarketplace not implemented")
}
func (UnimplementedMcpServiceServer) OpenMcpSettings(context.Context, *EmptyRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method OpenMcpSettings not implemented")
}
func (UnimplementedMcpServiceServer) AuthenticateMcpServer(context.Context, *StringRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthenticateMcpServer not implemented")
}
func (UnimplementedMcpServiceServer) SubscribeToMcpMarketplaceCatalog(*EmptyRequest, grpc.ServerStreamingServer[McpMarketplaceCatalog]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToMcpMarketplaceCatalog not implemented")
}
func (UnimplementedMcpServiceServer) GetLatestMcpServers(context.Context, *Empty) (*McpServers, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLatestMcpServers not implemented")
}
func (UnimplementedMcpServiceServer) SubscribeToMcpServers(*EmptyRequest, grpc.ServerStreamingServer[McpServers]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToMcpServers not implemented")
}
...
func _McpService_AuthenticateMcpServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(McpServiceServer).AuthenticateMcpServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: McpService_AuthenticateMcpServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(McpServiceServer).AuthenticateMcpServer(ctx, req.(*StringRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var McpService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "authenticateMcpServer",
			Handler:    _McpService_AuthenticateMcpServer_Handler,
		},
		{
